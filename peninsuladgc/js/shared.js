...
<nav class="nav" id="mainNav">
  ...
  <ul class="nav-links" id="navLinks">
    ...
    <li><a href="../events/index.html" class="${isActive('index.html')}">Events</a></li>
    <li><a href="../about/index.html" class="${isActive('index.html')}">About</a></li>
    <li><a href="../blog/index.html" class="${isActive('index.html')}">News & Blog</a></li>
