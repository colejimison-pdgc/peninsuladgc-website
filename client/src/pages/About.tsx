...
const ABOUT_IMAGE = "/images/eh_devin_hole4.jpg";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[oklch(0.97_0.015_85)]">
      ...
      >
        ...
        <div className="absolute inset-0 hidden md:block bg-gradient-to-b from-[oklch(0.12_0.04_55)/0.80] to-[oklch(0.12_0.04_55)/0.65]" />
        <div className="relative z-10 container">
          <div className="md:bg-[oklch(0_0_0/0.60)] md:backdrop-blur-sm rounded-lg p-8 max-w-2xl">
